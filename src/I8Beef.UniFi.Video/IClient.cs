...
namespace I8Beef.UniFi.Video
{
    ...
    public interface IClient : IDisposable
    {
        ...
        Task AuthorizeAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<Bootstrap> BootstrapAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation token.</param>
        /// <returns>A dynamic object containing the JSON response.</returns>
        Task<IEnumerable<Camera>> CameraAsync(string cameraId = null, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation token.</param>
        /// <returns>A dynamic object containing the JSON response.</returns>
        Task<IEnumerable<CameraMotion>> MotionAlertsAsync(DateTime startTime, DateTime endTime, int intervalSeconds = 2, IEnumerable<string> cameraIds = null, string sortBy = "startTime", string sort = "asc", CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation token.</param>
        /// <returns>A dynamic object containing the JSON response.</returns>
        Task<IEnumerable<Recording>> RecordingAsync(DateTime startTime, DateTime endTime, IEnumerable<string> cameraIds = null, IEnumerable<RecordingEventType> causes = null, string sortBy = "startTime", string sort = "desc", CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation token.</param>
        /// <returns>A dynamic object containing the JSON response.</returns>
        Task<IEnumerable<string>> RecordingIdAsync(DateTime startTime, DateTime endTime, IEnumerable<string> cameraIds = null, IEnumerable<RecordingEventType> causes = null, string sortBy = "startTime", string sort = "asc", CancellationToken cancellationToken = default(CancellationToken));
